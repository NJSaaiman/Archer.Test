    ...
    public class Randomizer
    {
        ...
        public string RandomName
        {
            get
            {
                ...
                {
                    name = _maleNames[_random.Next(0, _maleNames.Length)] + " " + _lastNames[_random.Next(0, _lastNames.Length)];
                }
                else
                {
                    name = _femaleNames[_random.Next(0, _femaleNames.Length)] + " " + _lastNames[_random.Next(0, _lastNames.Length)];
                }
        ...
        public string RandomCellNumber
        {
            get
            {
                ...
                //we need some invalid number lets modify them if they hit the unluck numbers.
        ...
        {
            name = name.Replace(" ", ".") + "@" + _mailDomains[_random.Next(0, _mailDomains.Length)];
            return name;
        }
        ...
        {
            string company = _companyNames[_random.Next(0, _companyNames.Length)];
            while (string.Compare(companyName, company, true) == 0)
            {
                company = _companyNames[_random.Next(0, _companyNames.Length)];
            }
